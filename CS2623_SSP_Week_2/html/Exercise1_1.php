...
<head>
    ...
    <title>CS 2623 - Example 1-1</title>
</head>
    <body>          
         <!-- Main Content-->
         <!-- Top navbar -->
            <div class="w3-container w3-center w3-dark-grey">
                <h1>CS 2623 SSP - Exercise 1-1</h1>
            </div>
         ...
         <div class="w3-container w3-twothird">
            ...
            <div class="w3-panel ">
                ...
                <div class="w3-container">
                     <p>Below is the contents of the Rate Array</p>
                     <?php 
                        //InterestRate.php
                        $InterestRate1 = .0725;
                        $InterestRate2 = .0750;
                        ...
                        $RateArray = array($InterestRate1,$InterestRate2,$InterestRate3,$InterestRate4,$InterestRate5,$InterestRate6,$InterestRate7);

                        $RateArrayCount = count($RateArray);

                        for($x = 0; $x < $RateArrayCount; $x++){
                            echo "<p> $RateArray[$x]</p>";
                        }
