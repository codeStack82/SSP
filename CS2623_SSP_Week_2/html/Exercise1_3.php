...
<head>
    ...
    <title>CS 2623 - Example 1-3 - Single Family Home</title>
</head>
    <body>          
         <!-- Main Content-->
          <!-- Top navbar -->
            <div class="w3-container w3-center w3-dark-grey">
                <h1>CS 2623 SSP - Exercise 1-3</h1>
            </div>
            ...
            <div class="w3-panel ">
                ...
                <div class="w3-container">
                    <?php 
                        ...
                        echo "<p>The current price of a single family home in OKC is $", $SingleFamilyHome_Print, "</p>";
                    ?>
                </div>
            </div><!--/ Card #1-->
