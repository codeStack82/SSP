...
<head>
    ...
    <title>CS 2623 - Example 1-4 - Days of the Week</title>
</head>
    <body>          
         <!-- Main Content-->
         <!-- Top navbar -->
            <div class="w3-container w3-center w3-dark-grey">
                <h1>CS 2623 SSP - Exercise 1-4</h1>
            </div>
            ...
            <div class="w3-panel ">
                ...
                <div class="w3-container">
                    <?php 
                        ...
                        echo "<p>The days of the week in English are:</p><hr/>"; 
                        echo "<p>$Days[0]</p>";
                        echo "<p>$Days[1]</p>";
                        echo "<p>$Days[2]</p>";
                        echo "<p>$Days[3]</p>";
                        ...
                        echo "<br/><p>The days of the week in French are: </p><hr/>"; 
                        echo "<p>$Days[0]</p>";
                        echo "<p>$Days[1]</p>";
                        echo "<p>$Days[2]</p>";
                        echo "<p>$Days[3]</p>";
